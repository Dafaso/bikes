...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { manufacturer_id: @bike.manufacturer_id, shop_id: @bike.shop_id, type: @bike.type } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { manufacturer_id: @bike.manufacturer_id, shop_id: @bike.shop_id, type: @bike.type } }
